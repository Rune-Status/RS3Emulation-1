...
import net.ieldor.network.codec.buf.ByteBufEncoder;
import net.ieldor.network.codec.handshake.HandshakeDecoder;
...
public class ChannelChildHandler extends ChannelInitializer<SocketChannel> {
	...
	public void initChannel(SocketChannel ch) throws Exception {
		ch.pipeline().addLast(new ReadTimeoutHandler(5), new ByteBufEncoder(), new HandshakeDecoder(), new ServerChannelAdapterHandler(mainContext));
	}
}
