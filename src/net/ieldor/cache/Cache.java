...
import net.ieldor.cache.ReferenceTable.Entry;
import net.ieldor.cache.util.ByteBufferUtils;
import net.ieldor.cache.util.crypto.Djb2;
import net.ieldor.cache.util.crypto.Whirlpool;
